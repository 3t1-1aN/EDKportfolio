...
function signedOffset(i: number, active: number, len: number, loop: boolean) {
  ...
  if (Math.abs(alt) < Math.abs(raw)) return alt;
  // When equidistant (even-length deck), always use the positive/right side
  // so all hidden cards route through the same direction for consistent animation
  if (Math.abs(alt) === Math.abs(raw)) return Math.max(alt, raw);
  return raw;
}
          ...
          <button
            ...
            className={cn(
              ...
              canGoPrev
                ...
                : "cursor-not-allowed border-foreground/20 text-foreground/30"
            )}
          >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    on
                      ...
                      : "border-foreground/40 bg-foreground/55 hover:bg-foreground/75"
                  )}
